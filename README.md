...
# | Moon Lander Mini Game | `moon-lander-game/`     | C，终端 UI                           | 编译后运行 `moon\_lander.exe` |
...
# gcc .\\src\\main.c -o .\\moon\_lander.exe -lm
...
>>>>>>> eeb3265 (Automated game update 2026-06-14 17:41)
